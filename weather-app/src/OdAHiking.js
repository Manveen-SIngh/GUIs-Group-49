...
function OdAHiking() {
  ...
  var mainActivityScore = w ? String(w.scores.hiking) : "9";
  var mainActivityColor = w ? scoreColor(w.scores.hiking) : '#3BC50F';
  ...
  var tempScoreColour      = w ? (w.today.tempHigh >= 10 && w.today.tempHigh <= 25 ? '#3BC50F' : '#FFAB1C') : '#3BC50F';
  ...
  var mainActivityMessage = w ? activityMessage("hiking", w.scores.hiking) : "It's a great day to go on a hike!";
  ...
  var precipMessage       = w ? (w.today.pop < 20 ? "Great trail conditions!" : w.today.pop < 50 ? "Soft ground ahead" : "Soft Ground!") : "Soft Ground!";
  ...
  return (
    ...
    <div style={{width:'100%',height:'100%',position:'absolute'}}>
      ...
      <div style={{width:60,height:60,left:277,top:36,position:'absolute'}}>
        <div style={{width:'100%',height:'100%',position:'absolute',left:15,top:15.5}}><img src={menuIcon} alt="menu"/></div>
      </div>
    </div>
    <div style={{width:'100%',height:'100%',position:'absolute'}}>
      <div style={{position:"absolute",left:280,top:110,font:"Rubik",fontSize:52,fontWeight:400,color:"black"}}>Outdoor Activity Summary</div>
    </div>
    <div style={{width:'100%',height:'100%',position:'absolute'}}>
      <div style={{position:"absolute",left:280,top:153,font:"Rubik",fontSize:92,fontWeight:500,color:"black"}}>{pageActivity}:</div>
    </div>
    <div style={{width:'100%',height:'100%',position:'absolute'}}>
    ...
    <div style={{width:'100%',height:'100%',position:'absolute',boxShadow:'0px 4px 4px rgba(0,0,0,0.25)'}}>
      ...
      <div style={{position:'absolute',top:730,left:440,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:35,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>Map</div>
    </div>
    ...
    <div style={{width:'100%',height:'100%',position:'absolute',boxShadow:'0px 4px 4px rgba(0,0,0,0.25)'}}>
      ...
      <div style={{position:'absolute',top:615,left:747,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:35,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>Temperature</div>
      ...
      <div style={{color:'rgba(0,0,0,0.70)',position:'absolute',top:724,left:755,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{tempHi}°{unitTemp}</div>
      <img style={{position:"absolute",top:719,left:737}} src={hiArrow} alt="hi"/>
      <div style={{color:'rgba(0,0,0,0.70)',position:'absolute',top:724,left:865,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{tempLo}°{unitTemp}</div>
    ...
    <div style={{width:'100%',height:'100%',position:'absolute',boxShadow:'0px 4px 4px rgba(0,0,0,0.25)'}}>
      ...
      <div style={{position:'absolute',top:295,left:745,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:35,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>Precipitation</div>
      <img style={{position:"absolute",height:86,width:98,top:345,left:700}} src={precipIconToday} alt="today"/>
      <div style={{position:'absolute',top:430,left:700,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:34,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>Today</div>
      <div style={{width:33,height:33,left:800,top:435,position:'absolute',background:currentPrecipScoreColour,borderRadius:10}}/>
      <div style={{position:'absolute',top:470,left:720,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:26,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>{precipToday}%</div>
      <img style={{position:"absolute",height:86,width:98,top:350,left:870}} src={precipIconPrev} alt="tmrw"/>
      <div style={{position:'absolute',top:430,left:880,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:34,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>Tmrw.</div>
      <div style={{width:33,height:33,left:965,top:435,position:'absolute',background:prevPrecipScoreColour,borderRadius:10}}/>
      <div style={{position:'absolute',top:470,left:890,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:26,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>{prevPrecipStatus}<br/>rain</div>
    ...
    <div style={{width:'100%',height:'100%',position:'absolute',boxShadow:'0px 4px 4px rgba(0,0,0,0.25)'}}>
      ...
      <div style={{position:'absolute',top:295,left:1160,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:35,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>Humidity</div>
      ...
      <div style={{color:'#FF6B6B',position:'absolute',top:390,left:1097,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>Hi</div>
      <div style={{color:'rgba(0,0,0,0.70)',position:'absolute',top:390,left:1140,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{HumidityTodayHi}%</div>
      <div style={{color:'#0048FF',position:'absolute',top:390,left:1242,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>Lo</div>
      <div style={{color:'rgba(0,0,0,0.70)',position:'absolute',top:390,left:1290,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{HumidityTodayLo}%</div>
      ...
      <div style={{color:'#FF6B6B',position:'absolute',top:505,left:1097,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>Hi</div>
      <div style={{color:'rgba(0,0,0,0.70)',position:'absolute',top:505,left:1140,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{HumidityPrevHi}%</div>
      <div style={{color:'#0048FF',position:'absolute',top:505,left:1242,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>Lo</div>
      <div style={{color:'rgba(0,0,0,0.70)',position:'absolute',top:505,left:1290,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{HumidityPrevLo}%</div>
    </div>
    ...
    <div style={{width:'100%',height:'100%',position:'absolute',boxShadow:'0px 4px 4px rgba(0,0,0,0.25)'}}>
      ...
      <div style={{position:'absolute',top:615,left:1150,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:35,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>Visibility</div>
      ...
      <div style={{color:'#FF6B6B',position:'absolute',top:717,left:1097,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>Hi</div>
      <div style={{color:'rgba(0,0,0,0.70)',position:'absolute',top:717,left:1137,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{visibilityTodayHi}{distanceUnit}</div>
      <div style={{color:'#0048FF',position:'absolute',top:717,left:1242,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>Lo</div>
      <div style={{color:'rgba(0,0,0,0.70)',position:'absolute',top:717,left:1287,display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{visibilityTodayLo}{distanceUnit}</div>
      <div style={{color:"black",position:'absolute',top:800,left:1134,textAlign:"center",display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>Right Now:</div>
      <div style={{color:"black",position:'absolute',top:837,left:1189,textAlign:"center",display:'flex',flexDirection:'column',fontSize:36,fontFamily:'Rubik',fontWeight:'400'}}>{visibilityNow}{distanceUnit}</div>
    </div>
    ...
    <div style={{width:'100%',height:'100%',position:'absolute',boxShadow:'0px 4px 4px rgba(0,0,0,0.25)'}}>
      ...
      <div style={{position:'absolute',top:295,left:1453,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:35,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>. Wind<br/>Speed</div>
      ...
      <div style={{color:"black",position:'absolute',top:445,left:1465,textAlign:"center",display:'flex',flexDirection:'column',fontSize:25,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>{windSpeed}{distanceUnitSpeed}ph</div>
      <div style={{color:"black",position:'absolute',top:535,left:1465,textAlign:"center",display:'flex',flexDirection:'column',fontSize:22,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>Daily<br/>Average</div>
    </div>
    ...
    <div style={{width:'100%',height:'100%',position:'absolute',boxShadow:'0px 4px 4px rgba(0,0,0,0.25)'}}>
      ...
      <div style={{position:'absolute',top:615,left:1490,textAlign:'center',display:'flex',flexDirection:'column',color:'black',fontSize:35,fontFamily:'Rubik',fontWeight:'400',letterSpacing:0.50}}>UV</div>
